...
java -jar ckbuilder/$CKBUILDER_VERSION/ckbuilder.jar --build ../../ ../../../../webroot/js/ckeditor-dist --version="4.3.5 DEV" --build-config build-config.js --overwrite --no-zip --no-tar "$@"
